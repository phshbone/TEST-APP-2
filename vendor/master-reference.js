(function(){
  ...
  button.type='button';
  button.textContent='Master Reference';
  ...
  button.onclick=()=>{
    ...
    alert('Master Reference shell is reserved for Morris technical material. Sensitive Morris manuals are not bundled in this public demo build.');
  };
})();
